...
class MapD():
  ...
  def publish(self, pm, sm):
    ...
    slc.map_next_speed_limit_way_distance_to_end = 0 if next_speed_limit_way_distance_to_end is None else int(next_speed_limit_way_distance_to_end)
    ...
    slc.map_distance_to_end_of_current_way = 0 if self.route.distance_to_end_of_current_wr is None else int(self.route.distance_to_end_of_current_wr)
    slc.map_distance_to_end_of_next_way = 0 if self.route.distance_to_end_of_next_wr is None else int(self.route.distance_to_end_of_next_wr)
