...
class ModelState:
  ...
  def __init__(self, cam_w: int, cam_h: int, usbgpu: bool):
    ...
    self.policy_output_len = policy_metadata['output_shapes']['outputs'][1]
  ...
  def run(self, bufs: dict[str, VisionBuf], transforms: dict[str, np.ndarray],
    ...
    vision_output, policy_output, off_policy_output = np.split(outs.numpy()[0], [self.vision_output_len, self.vision_output_len + self.policy_output_len])
