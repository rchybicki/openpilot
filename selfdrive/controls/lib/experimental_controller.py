...
class ExperimentalController():
  ...
  def lead_braking(self, lead, personality, dist_in_s):
    ...
    lead_braking = dist_in_s < 4 and self.radarState.leadOne.aLeadK <= -0.3 or active and self.radarState.leadOne.aLeadK <= -0.05
  ...
  def lead_speed(self, lead, personality, dist_in_s):
    self.lead_speed_active = lead and personality!=log.LongitudinalPersonality.aggressive \
                              and (self.radarState.leadOne.vLead * CV.MS_TO_KPH < 10. and dist_in_s > 3 or self.lead_speed_active and self.radarState.leadOne.vLead * CV.MS_TO_KPH < 15.)
