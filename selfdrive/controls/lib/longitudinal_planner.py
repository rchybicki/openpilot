...
class LongitudinalPlanner:
  ...
  def update(self, sm, classic_longitudinal, frogpilot_toggles):
    ...
    self.mpc.update(sm['radarState'], sm['frogpilotRadarState'], v_cruise, x, v, a, j, sm['frogpilotPlan'].tFollow, sm['frogpilotPlan'].trackingLead, personality=sm['controlsState'].personality)
