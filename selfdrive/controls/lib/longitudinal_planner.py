...
class LongitudinalPlanner:
  ...
  def update(self, sm, classic_longitudinal, frogpilot_toggles):
    mode = 'blended' if (sm['controlsState'].experimentalMode or sm['frogpilotPlan'].experimentalMode) else 'acc'
    ...
    self.mpc.update(sm['radarState'], sm['frogpilotRadarState'], v_cruise, x, v, a, j, 
                    sm['frogpilotPlan'].tFollow, sm['frogpilotPlan'].trackingLead, 
 					frogpilot_toggles,
