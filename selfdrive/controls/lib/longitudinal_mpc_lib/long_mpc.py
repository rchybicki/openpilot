...
class LongitudinalMpc:
  ...
  def update(self, radarstate, v_cruise, x, v, a, j, t_follow, frogpilot_toggles, personality=log.LongitudinalPersonality.standard, short_distance_factor=0.0, long_distance_factor=0.0):
    v_ego = self.x0[1]
