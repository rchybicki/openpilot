...
DIST_V_GAP3 = [ 1.9,  1.9,  1.90, 1.90, 1.85, 1.8,  1.7,  1.7,  1.7,  1.7,  1.7 ]
...
def get_T_FOLLOW(personality=log.LongitudinalPersonality.standard, v_ego = 0., exp_mode = False):
  if personality==log.LongitudinalPersonality.relaxed:
    return 1.25 if exp_mode else np.interp(v_ego, DIST_V_BP, DIST_V_GAP3)
  elif personality==log.LongitudinalPersonality.standard:
    return 1.0 if exp_mode else np.interp(v_ego, DIST_V_BP, DIST_V_GAP2)
  elif personality==log.LongitudinalPersonality.aggressive:
    return 1.0 if exp_mode else np.interp(v_ego, DIST_V_BP, DIST_V_GAP1)
  else: #snow
