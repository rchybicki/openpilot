...
class CarController(CarControllerBase):
  ...
  def update(self, CC, CS, now_nanos):
    ...
    if self.CP.carFingerprint in CANFD_CAR:
      ...
      reset_state = CC.actuators.longControlState == LongCtrlState.off
      self.engaged = min(1000, self.engaged + 1) if not reset_state and self.CP.openpilotLongitudinalControl else 0
      ...
      if self.frame % 2 == 0 and self.CP.openpilotLongitudinalControl:
        ...
        engaged_active = v_ego_kph < 50. and self.engaged < 400
        plan_error = 0
        accel = min(max(CS.out.aEgo * 1.5, 0.7), accel) if engaged_active and accel > CS.out.aEgo else accel
