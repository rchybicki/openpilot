...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"ExperimentalLongitudinalEnabled", {PERSISTENT | DEVELOPMENT_ONLY, BOOL, "0"}},
    ...
    {"AggressivePersonalityProfile", {PERSISTENT, BOOL, "0", "0", 2}},
    ...
    {"CalibratedLateralAccelerationOverride", {PERSISTENT, FLOAT, "0.0", "0.0", 2}},
    ...
    {"CENavigation", {PERSISTENT, BOOL, "0", "0", 1}},
    ...
    {"HondaAltTune", {PERSISTENT, BOOL, "0", "0", 2}},
    {"HondaLowSpeedPedal", {PERSISTENT, BOOL, "0", "0", 2}},
    {"HondaMaxBrake", {PERSISTENT, BOOL, "0", "0", 2}},
    ...
    {"LongDistanceFactor", {PERSISTENT, FLOAT, "1.0", "1.0", 3}},
    ...
    {"LongPitch", {PERSISTENT, BOOL, "0", "0", 2}},
    ...
    {"Hyundai-RadarTracks", {PERSISTENT, BOOL, "0", "0", 2}},
    ...
    {"RelaxedPersonalityProfile", {PERSISTENT, BOOL, "0", "0", 2}},
    ...
    {"SLCPriority3", {PERSISTENT, STRING, "None", "None", 2}},
    ...
    {"ShortDistanceFactor", {PERSISTENT, FLOAT, "1.0", "1.0", 3}},
    ...
    {"StandardPersonalityProfile", {PERSISTENT, BOOL, "0", "0", 2}},
    ...
    {"TrafficPersonalityProfile", {PERSISTENT, BOOL, "0", "0", 2}},
