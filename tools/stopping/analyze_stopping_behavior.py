...
def build_summary_markdown(
  ...
  lines.append("")
  lines.append(
    "|Event|Source|Seg|Approach|Entry|Duration|Rollout2m|EndJerk|EndStep|CmdJerk|CmdStep|"
  ...
  lines.append("- `Rollout2m` is distance traveled from first vEgo <= 2.0 m/s until standstill hold.")
