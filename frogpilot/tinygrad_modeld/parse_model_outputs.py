...
class Parser:
  ...
  def parse_policy_outputs(self, outs: dict[str, np.ndarray]) -> dict[str, np.ndarray]:
    ...
    if 'planplus' in outs:
      planplus_mhp = self.is_mhp(outs, 'planplus', ModelConstants.IDX_N * ModelConstants.PLAN_WIDTH)
      planplus_in_N, planplus_out_N = (ModelConstants.PLAN_MHP_N, ModelConstants.PLAN_MHP_SELECTION) if planplus_mhp else (0, 0)
      self.parse_mdn('planplus', outs, in_N=planplus_in_N, out_N=planplus_out_N,
