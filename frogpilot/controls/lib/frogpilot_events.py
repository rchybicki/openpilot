  ...
  def update(self, v_cruise, sm, frogpilot_toggles):
    ...
    if self.random_event_playing:
      ...
      if self.random_event_timer >= 5:
        self.theme_manager.update_wheel_image(frogpilot_toggles.wheel_image, frogpilot_toggles.current_holiday_theme, False)
    ...
    if not self.random_event_playing and frogpilot_toggles.random_events:
      ...
      if not self.accel30_played and 3.5 > self.max_acceleration >= 3.0 and acceleration < 1.5:
        ...
        self.theme_manager.update_wheel_image("weeb_wheel")
        ...
        self.theme_manager.update_wheel_image("tree_fiddy")
        ...
        self.theme_manager.update_wheel_image("great_scott")
      ...
      if saturated_alert_match:
        ...
        if event_choices and random.random() < RANDOM_EVENTS_CHANCE:
          ...
          if event_choice == "firefoxSteerSaturated":
            ...
            self.theme_manager.update_wheel_image("firefox")
            ...
            self.theme_manager.update_wheel_image("goat")
            ...
            self.theme_manager.update_wheel_image("this_is_fine")
