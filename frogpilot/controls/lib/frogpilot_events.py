...
class FrogPilotEvents:
  ...
  def update(self, v_cruise, sm, frogpilot_toggles):
    ...
    alerts_empty = len(self.event_names) == 0 and len(self.frogpilot_event_names) == 0
    ...
    self.startup_seen |= FrogPilotEventName.customStartupAlert in self.frogpilot_event_names
