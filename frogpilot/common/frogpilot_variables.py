...
class FrogPilotVariables:
  ...
  def update(self, holiday_theme="stock", started=False):
    ...
    toggle.experimental_free_road_boost_gain = self.get_value("CEExperimentalBoostGain", cast=float, condition=toggle.openpilot_longitudinal, default=1.0, min=0.0, max=2.0)
