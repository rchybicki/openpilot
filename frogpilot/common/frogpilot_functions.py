...
def convert_params(params_cache):
  ...
  if Path("/cache/tracking").exists():
    ...
    params.put_int("FrogPilotDrives", params_tracking.get_int("FrogPilotDrives"))
    params.put_int("FrogPilotKilometers", params_tracking.get_int("FrogPilotKilometers"))
    params.put_int("FrogPilotMinutes", params_tracking.get_int("FrogPilotMinutes"))
