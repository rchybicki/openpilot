...
private:
  ...
  QSet<QString> conditionalExperimentalKeys = {"CESpeed", "CESpeedLead", "CECurves", "CECscCurves", "CEExperimentalBoostGain", "CEExperimentalNoLeadBoostGain", "CEForceCoastStrength", "CELead", "CEModelStopTime", "CENavigation", "CESignalSpeed", "CEStopLights", "ShowCEMStatus"};
  QSet<QString> curveSpeedKeys = {"CalibratedLateralAcceleration", "CalibratedLateralAccelerationOverride", "CalibrationProgress", "CSCBrakingForce", "CSCBrakingForceHighSpeedReduction", "ResetCurveData", "ShowCSCStatus"};
